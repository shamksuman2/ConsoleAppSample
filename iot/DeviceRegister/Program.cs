...
namespace DeviceRegistration
{
    class Program
    {
        ...
        private static string GetTelemetryMessages()
        {
            ...
            string[] itemName =
            {
                "Red Pepper", "Black Olives", "American Chees", "Ham", "Jalpenos", "Green Papper", "Chicken Strips",
                "Becon", "Red Pepper", "Black Olives", "American Chees", "Ham", "Jalpenos", "Green Papper",
                "Chicken Strips", "Becon"
            };
